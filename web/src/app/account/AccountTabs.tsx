...
import { Camera, Mail, User, Calendar, Clock, Shield, Bell, Plug, Code, Zap, Globe } from 'lucide-react';
...
export function AccountTabs({ initialTab = 'profile' }: AccountTabsProps) {
          ...
          <div className="mx-auto max-w-4xl space-y-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
              ...
              <TabsContent value="profile" className="space-y-4">
                ...
                {/* Security Section (merged into Profile) */}
