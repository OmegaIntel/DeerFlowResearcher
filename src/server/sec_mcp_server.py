...
# sec_edgar_user_agent = "{firstname} {lastname} ({email})"
sec_edgar_user_agent = ""


# Initialize MCP
mcp = FastMCP("SEC EDGAR MCP", host="localhost", port=8181, dependencies=["secedgar"])
...
# use "mcp dev server.py" to run the server in inspector mode